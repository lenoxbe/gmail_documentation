...
<img src="{{ site.baseurl }}/images/reply-highlighted.jpg" alt="Reply Button" style="width: 80%;">
...
1. Open an email and click the Forward button below the message text.
	<img src="{{ site.baseurl }}/images/forward-highlighted.jpg" alt="Forward Button" style="width: 80%;">
