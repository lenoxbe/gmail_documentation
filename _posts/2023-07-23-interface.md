...
The search bar allows the user to search for mail in a variety of ways.
...
- A toolbar along the top of the reading pane that allows the user to (from left to right):
